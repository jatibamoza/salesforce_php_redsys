...
export default class Fan_LWC002_accountDeportes extends LightningElement {
    @api recordId;	
	@api object;
	@api deporte1;
	@api deporte2;
	...
	initIcons()
	{
		...
		getDeportesFavoritos({idCuenta:this.recordId, Campo:"Favoritos"})
			.then((result) => {
